package io.bootify.biblio_mongo.util;

import static io.bootify.biblio_mongo.util.MongoOffsetDateTimeWriter.DATE_FIELD;
import static io.bootify.biblio_mongo.util.MongoOffsetDateTimeWriter.OFFSET_FIELD;
